...
#ifndef SOKULOBBIES_SHIFTJISCONVTABLE_INL
#define SOKULOBBIES_SHIFTJISCONVTABLE_INL


#include <map>

const std::map<unsigned short, unsigned short> shiftJISConvTable = {
	{{0x0020}, {0x0020}}, // SPACE
...
#endif //SOKULOBBIES_SHIFTJISCONVTABLE_INL
